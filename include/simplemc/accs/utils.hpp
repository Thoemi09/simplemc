 ...
 * - `a.mean()` returns the sample mean (see simplemc::accs::mean)
 *
 * @tparam A Type to check.
 */
template <typename A>
 ...
 * - `a.variance()` returns the sample variance of the mean (see simplemc::accs::diag_covariance).
 *
 * @tparam A Type to check.
 */
template <typename A>
 ...
 * - `a.covariance()` returns the sample covariance matrix of the mean (see
