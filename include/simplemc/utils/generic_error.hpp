 ...
 *
 * This class serves as a base class for all exceptions in the simplemc library. It inherits from std::runtime_error and
 * provides a constructor and a virtual function for constructing error messages.
 */
