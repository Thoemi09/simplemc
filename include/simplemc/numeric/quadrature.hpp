 ...
 * limits of integration, the approximate value of integral and the current level of approximation.
 *
 ...
 */
template <typename F>
double trapez_quadrature(F&& f, double a, double b, double eps = 1e-7, int max = 20, int min = 5) {
    double current = 0.0;
    double old = 0.0;
 ...
 */
template <typename F>
double simpson_quadrature(F&& f, double a, double b, double eps = 1e-7, int max = 20, int min = 5) {
    double current = 0.0;
    double old = 0.0;
