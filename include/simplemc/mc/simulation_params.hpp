...
struct simulation_params {
    ...
    /// Stop the run once this much wall-clock time has elapsed. Default: \f$ 10 \f$ seconds.
    double max_time = 10.0;

    /// Number of update attempts between measurement opportunities. Default: \f$ 5 \f$.
    std::uint64_t steps_per_cycle = 5;

    /// Number of measurement cycles between stop-criteria polls. Default: \f$ 10^6 \f$.
