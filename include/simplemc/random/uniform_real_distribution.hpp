...
/**
 * @brief Read textual representation of urd_param_type from istream. Throws an
...
public:
     ...
     * @return Minimum value generated by the distribution.
     */
    double min() const { return param_.min(); }
     ...
     * @return Maximum value generated by the distribution.
     */
    double max() const { return param_.max(); }
...
/**
 * @brief Restore uniform_real_distribution from istream. If reading from
 * istream fails, the state is left unchanged.
 *
