 ...
 * @brief Uniform real distribution on an interval \f$ [a, b) \f$ of the real line.
 *
 ...
 * used with simplemc::xoshiro256 generators (although any other 64-bit engine works as well if it
 ...
 *
 *     // print 5 random samples from a uniform distribution defined on [-1, 1)
 *     simplemc::uniform_real_distribution dist(-1, 1);
 *     for (int i = 0; i < 5; ++i) {
...
public:
     ...
     *
     * @details It represents a closed-open interval \f$ [a, b) \f$ on the real line and defines the
    ...
    public:
        ...
        /**
         * @brief Get lower bound \f$ a \f$ of the interval \f$ [a, b) \f$.
         *
         * @return Lower bound of the interval.
         */
        [[nodiscard]] double min() const { return a_; }

        /**
         * @brief Get upper bound \f$ b \f$ of the interval \f$ [a, b) \f$.
         *
         * @return Upper bound of the interval.
         */
        [[nodiscard]] double max() const { return b_; }
    ...
    /**
     * @brief Construct a uniform distribution on the interval \f$ [a, b) \f$.
     *
     * @param a Lower bound of the interval.
     * @param b Upper bound of the interval.
     */
    explicit uniform_real_distribution(double a = 0.0, double b = 1.0) : param_(a, b) {}

    /**
     * @brief Construct a uniform distribution from given distribution parameters.
     *
     * @param param Parameters specifying the domain \f$ [a, b) \f$ of the distribution.
     */
     ...
     * @return Random double from the domain \f$ [a, b) \f$ of the distribution.
     */
     ...
     * @return Random double from the domain \f$ [a, b) \f$ according to the given distribution
     * parameters.
     */
    template <typename RNG>
