 ...
 *
 * @details It is implemented as a very thin wrapper around the actual MPI_Comm
 * object. Only the most basic functionality is supported (MPI_Comm_rank,
 * MPI_Comm_size, MPI_Barrier).
 */
class communicator {
public:
    /**
